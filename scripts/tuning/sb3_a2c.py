...
def create_model_from_parameters(env: Env, activation_fn: str, pi_arch: str, vf_arch: str, learning_rate: float, gae_lambda: float, ent_coef: float, vf_coef: float, gamma: float) -> A2C:
